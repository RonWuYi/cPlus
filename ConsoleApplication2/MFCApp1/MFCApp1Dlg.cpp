...
BEGIN_MESSAGE_MAP(CMFCApp1Dlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_CBN_SELCHANGE(IDC_COMBO1, &CMFCApp1Dlg::OnCbnSelchangeCombo1)
END_MESSAGE_MAP()
...
void CMFCApp1Dlg::OnCbnSelchangeCombo1()
{
	...
	nSel = m_comboIp.GetCurSel();

	m_comboIp.GetLBText(nSel, strWeb);
  
	SetDlgItemText(IDC_EDIT1, strWeb);
}

int CMFCApp1Dlg::GetIpAddr()
{
...
// the primary and secondary WINS server for each adapter. 
    ...
    if ((dwRetVal = GetAdaptersInfo(pAdapterInfo, &ulOutBufLen)) == NO_ERROR) {
        ...
        while (pAdapter) {
            ...
            m_comboIp.AddString((CA2W)(pAdapter->IpAddressList.IpAddress.String));
            printf("\tIP Address: \t%s\n",
