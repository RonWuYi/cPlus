// scalingII.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
static AVPacket pkt;
static FILE* file;
static struct SwsContext* sws_context = nullptr;

static void ffmpeg_encoder_init_frame(AVFrame** pframe, int width, int height)
{
    int ret;
    AVFrame* frame;
